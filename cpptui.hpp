...
namespace tui {
    namespace cursor {
        ...
        inline std::string next_line(int n = 1) {
            std::ostringstream oss;
            oss << "\033[" << n << "E";
            return oss.str();
        }
        inline std::string prev_line(int n = 1) {
            std::ostringstream oss;
            oss << "\033[" << n << "F";
            return oss.str();
        }
        inline constexpr const char *request_position() { return "\033[6n"; }
        inline constexpr const char *cursor_up() { return "\033M"; }
        inline constexpr const char *save_dec() { return "\0337"; }
        inline constexpr const char *restore_dec() { return "\0338"; }
    } // namespace cursor

    namespace screen {
        inline constexpr const char *clear() { return "\033[2J"; }
        inline constexpr const char *clear_line() { return "\033[2K"; }
        ...
        inline std::string erase_in_line(int n = 0) {
            std::ostringstream oss;
            oss << "\033[" << n << "K";
            return oss.str();
        }
        inline std::string erase_in_display(int n = 0) {
            std::ostringstream oss;
            oss << "\033[" << n << "J";
            return oss.str();
        }
        inline std::string erase_saved_lines() { return "\033[3J"; }
    } // namespace screen
    ...
    class tui_string : public std::string {
      public:
        ...
        inline tui_string bold() const { return text::bold(*this); }

        inline tui_string dim() const { return text::dim(*this); }

        inline tui_string italic() const { return text::italic(*this); }

        inline tui_string underline() const { return text::underline(*this); }

        inline tui_string blink() const { return text::blink(*this); }

        inline tui_string inverted() const { return text::inverted(*this); }
        ...
        inline tui_string red() const { return text::red(*this); }

        inline tui_string green() const { return text::green(*this); }

        inline tui_string yellow() const { return text::yellow(*this); }

        inline tui_string blue() const { return text::blue(*this); }

        inline tui_string magenta() const { return text::magenta(*this); }
        ...
        inline tui_string bg_black() const {
            std::ostringstream oss;
            oss << text::bg::black() << *this << text::reset();
            return oss.str();
        }
        inline tui_string bg_red() const {
            std::ostringstream oss;
            oss << text::bg::red() << *this << text::reset();
            return oss.str();
        }
        inline tui_string bg_green() const {
            std::ostringstream oss;
            oss << text::bg::green() << *this << text::reset();
            return oss.str();
        }
        inline tui_string bg_yellow() const {
            std::ostringstream oss;
            oss << text::bg::yellow() << *this << text::reset();
            return oss.str();
        }
        inline tui_string bg_blue() const {
            std::ostringstream oss;
            oss << text::bg::blue() << *this << text::reset();
            return oss.str();
        }
        inline tui_string bg_magenta() const {
            std::ostringstream oss;
            oss << text::bg::magenta() << *this << text::reset();
            return oss.str();
        }
        inline tui_string bg_cyan() const {
            std::ostringstream oss;
            oss << text::bg::cyan() << *this << text::reset();
            return oss.str();
        }
        inline tui_string bg_white() const {
            std::ostringstream oss;
            oss << text::bg::white() << *this << text::reset();
            return oss.str();
        }
        inline std::string rgb(int r, int g, int b) {
            std::ostringstream oss;
